...
public class listcalonsiswa extends ListActivity {
	...
	String id; //tambah
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			try
			{
				...
				HttpPost httpPost =
					new HttpPost("http://10.0.2.2:80/jsonandroid/calonsiswa2.php");
					//ganti
		...
		private void fillData()
		{
			...
			ListAdapter siswabaruadapter = new SimpleAdapter(this, datastaff, R.layout.listsiswa_item3, new String[] {
					...
					new int[] {R.id.namasiswa, R.id.namasekolah, R.id.namajurusan});
		...
		protected void onListItemClick(ListView l, View v, int position, long id) {
			...
			i.putExtra("sekolah", item.nama_sekolah);
			i.putExtra("jurusan", item.nama_jurusan);
