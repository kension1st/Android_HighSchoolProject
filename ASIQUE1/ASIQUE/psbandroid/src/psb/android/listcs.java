...
public class listcs extends ListActivity {
	...
	String id; //tambah
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			try
			{
				...
				HttpPost httpPost =
					new HttpPost("http://10.0.2.2:80/jsonandroid/caricalonsiswasekolah.php?id="+id);
					//ganti
		...
		private void fillData()
		{
			...
			ListAdapter siswabaruadapter = new SimpleAdapter(this, datastaff, R.layout.listsiswa_item, new String[] {
